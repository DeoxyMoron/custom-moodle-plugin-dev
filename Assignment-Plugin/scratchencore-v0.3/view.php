...
//echo $scratchencore->externalurl;
//echo $OUTPUT->box(format_string($scratchencore->name));
//echo $OUTPUT->box(format_string($scratchencore->intro));
//echo $OUTPUT->box($scratchencore->covfefe);
//echo $scratchencore->foobar;
//foreach ($scratchencore as $value) {
//    echo $value;
//    echo '>>>>';
//}
