...
/**
 * Tests for mod/assign/submission/scratch/locallib.php
 *
...
/**
 * Unit tests for mod/assign/submission/scratch/locallib.php
 *
 * @copyright  2016 Cameron Ball
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignsubmission_scratch_locallib_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $params = ['course' => $this->course->id, 'assignsubmission_scratch_enabled' => 1];
    ...
    public function test_submission_is_empty($submissiontext, $expected) {
        ...
        $data = new stdClass();
        $data->scratch_editor = ['text' => $submissiontext];
