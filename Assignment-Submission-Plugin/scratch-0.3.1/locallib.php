...
. 'insert custom HTML - ' . $scratchid . '</h2></div></div>';
        ...
        $html2 .= 'var cars = ["saavb", "volvo"];';
        $html2 .= 'cars[0];';
        $html2 .= '<h2>asdf</h2>';
        $mform->addElement('static', 'div_menu', '', $html2);
    ...
    public function save(stdClass $submission, stdClass $data) {
        ...
        if ($scratchsubmission) {
            ...
            //Get scratch data from the submitted url.
            //$result = "foobar";


            //$scratchsubmission->json wario
            ...
            //Get scratch data from the submitted url.
            //$result = file_get_contents($scratchsubmission->scratch);
            //$scratchsubmission->json = $result;
            //$result = "foobar";
            //$scratchsubmission->json = $result;
            //$scratchsubmission->projremix = $data->projremix;
    ...
    public function jsontest(){
      ...
      $projjson = file_get_contents('https://api.scratch.mit.edu/users/djsanosa/projects');
